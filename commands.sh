...
python manage.py load_bible_json --file /Users/vbellotech/Desktop/START\ UP/Berea/Berea_BE/berea/bible/fixtures/kjv/ylt_bible.json --translation YLT &&
python manage.py load_strongs &&
python manage.py load_tagged_greek_nt &&
python manage.py load_tagged_hebrew_ot &&
python manage.py add_psalm_superscriptions && python manage.py load_cross_references &&

python manage.py load_tagged_greek_nt --translation YLT && python manage.py load_tagged_hebrew_ot --translation YLT

python manage.py add_psalm_superscriptions --translation YLT && python manage.py load_cross_references --translation YLT
